/**
 * Capture screenshots of the round-4 additions: opencode, hermes, the new
 * errors landing, refreshed tools, and the home page with the interactive
 * token-group filter.
 */
...
async function main() {
  ...
  for (const route of ROUTES) {
    const id = route === '/' ? 'r4-home' : 'r4-' + route.replace(/^\//, '').replace(/\//g, '__');
